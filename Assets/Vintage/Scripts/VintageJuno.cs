...
namespace VintageImageEffects
{
  ...
  [AddComponentMenu("Image Effects/Vintage/Vintage Juno")]
  public sealed class VintageJuno : ImageEffectBase
  {
    /// <summary>
    /// Effect description.
    /// </summary>
    public override string Description { get { return @"It tints cool tones green, amps up warm tones, and makes whites glow."; } }

    /// <summary>
    /// Shader path.
    /// </summary>
    protected override string ShaderPath { get { return @"Shaders/VintageJuno"; } }
    ...
    protected override void CreateMaterial()
    {
      ...
      lutTex = VintageHelper.CreateTexture3DFromResources(@"Textures/junoLut", 16);
